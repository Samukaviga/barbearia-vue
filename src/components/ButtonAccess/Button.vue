<template>
  ...
  <button data-modal-target="crud-modal" data-modal-toggle="crud-modal" type="button" data-tooltip-target="tooltip-copy" data-tooltip-placement="left"
  ...
  <slot />
    ...
    <span class="sr-only">{{ nameButton }}</span>
  </button>
...
const props = defineProps(['nameButton'])
